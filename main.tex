...
% minors 
\def\Wi{W(i,\bm f)}
\def\WiA{W(i,V(\bm f^{\mA}))}
\def\WifA{W(i,V(\bm f^{\A}))}
\def\I{\mathfrak{I}}
...
%\DeclareMathOperator{\lag}{Lagrange}
\def\lag{{\bm{Lagrange}}}
\def\lagF{{\bm{Lagrange}}(\bm f,i,(L_1,\hdots,L_s))}
\def\lagFA{{\bm{Lagrange}}(\bm f^{\mA},i,(L_1,\hdots,L_s))}
\def\lagFAl{{\bm{Lagrange}}(\bm f^{\mA},i,(l_1,\hdots,l_s))}
\def\lagFfA{{\bm{Lagrange}}(\bm f^{\A},i,(L_1,\hdots,L_s))}
%\def\W{\mathfrak{I}}
% lagrange 
\def\Il{\mathscr{I}_{\ub}}
\def\Iil{\mathscr{I}_{\ub}(i,\bm f)}
\def\IilA{\mathscr{I}_{\ub}(i,\bm f^{\mA})}
\def\IilAnu{\mathscr{I}(i,\bm f^{\mA})}
\def\IilfA{\mathscr{I}_{\ub}(i,\bm f^{\A})}
\def\IilfAV{\mathscr{I}_{\bm V}(i,\bm f^{\A})}
...
\def\Clos#1{\ensuremath{{\mathscr{Var}#1}}}
...
\def\a {\ensuremath{\bm{a}}}
\def\b {\ensuremath{\bm{b}}}
\def\z {\ensuremath{\mathbf{z}}}
\def\x {\ensuremath{{\bm{x}}}}
\def\w {\ensuremath{\bm{w}}}
\def\f {\ensuremath{\mathbf{f}}}
\def\r {\ensuremath{\mathbf{r}}}
\def\s {\ensuremath{\bm{s}}}
\def\L {\ensuremath{{\bm L}}}
\def\F {\ensuremath{\bm{F}}}
\def\G {\ensuremath{\bm{G}}}
\def\I {\ensuremath{\bm{I}}}
\def\E {\ensuremath{\mathbf{E}}}
\def\X {\ensuremath{{\bm X}}}   
\def\Y {\ensuremath{{\bm Y}}}
\def\H {\ensuremath{{\bm H}}}
\def\bfA {\ensuremath{\mathbf{A}}}
\def\m {\ensuremath{\mathfrak{m}}}
\def\v {\ensuremath{{\bm v}}}
\def\u {\ensuremath{{\bm u}}}   
\def\q {\ensuremath{\mathbf{q}}}
\def\U {\ensuremath{\mathbf{S}}}
\def\V {\ensuremath{\mathbf{B}}}
...
\def\ElimLagrange{{\sf ElimLagrange}}
\def\SingularPoints{{\sf SingularPoints}}
\def\Lagrange{{\sf FirstOrderLagrange}}
\def\PolarLagrange{{\sf LagrangeSystem\-For\-Polar\-Variety}}
\def\SLagrange{{\sf SecondOrderLagrange}}
\def\Polar{{\sf Polar}}
\def\QuadPolarPoints{{\sf QuadPolarPoints}}
\def\CannyPolarPoints{{\sf CannyPolarPoints}}
\def\PolarCurve{{\sf PolarCurve}}
\def\CannyPolarCurve{{\sf CannyPolarCurve}}
\def\PolarParam{{\sf PolarParam}}
\def\PolarPointsLagrange{{\sf PolarPoints}}
\def\PolarPointsParameterization{{\sf PolarPointsParameterization}}
...
%\newcommand{\mainRoadmap}{\fontfamily{qcr}\selectfont mainRoadmap} % 
%\newcommand{\modularRoadmap}{\fontfamily{qcr}\selectfont modularRoadmap} % 
%\newcommand{\solve}{\fontfamily{qcr}\selectfont solve} % 
%\newcommand{\projection}{\fontfamily{qcr}\selectfont projection} % 
%\newcommand{\applyChangeOfVariables}{\fontfamily{qcr}\selectfont applyChangeOfVariables} % 
%\newcommand{\lift}{\fontfamily{qcr}\selectfont lift} % 
%\newcommand{\union}{\fontfamily{qcr}\selectfont union} % 
%\newcommand{\liftW}{\fontfamily{qcr}\selectfont liftW} % 
%\newcommand{\criticalCurve}{\fontfamily{qcr}\selectfont criticalCurve} % 
%\newcommand{\requiredCriticalPoints}{\fontfamily{qcr}\selectfont requiredCriticalPoints} % 
...
\def\myminor{{\ensuremath{\mathbf{m}}}}
\def\c{{\bm{c}}}

\def\dunder{{\underline{d}}}
\def\polring#1{#1[X_1, \ldots, X_n]}
\newcommand{\fbr}[2]{{#1}_{#2}}
\newcommand{\fbrss}[3]{{#1}^{#2}_{#3}}
\newcommand{\Wo}{W^\circ}
\newcommand{\W}{W}
\newcommand{\Kr}{K}
